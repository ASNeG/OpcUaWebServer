...
namespace OpcUaWebServer
{
	...
	std::string
	HttpRequest::method(void)
	{
		return method_;
	}

	std::string
	HttpRequest::path(void)
	{
		return path_;
	}

	std::string
	HttpRequest::httpVersion(void)
	{
		return httpVersion_;
	}

	void
	HttpRequest::content(const std::string& content)
	{
		content_ = content;
	}

	std::string&
	HttpRequest::content(void)
	{
		return content_;
	}
	...
	bool
	HttpRequest::decodeRequestHeader(std::istream& is)
	{
		std::string line;
		clear();
	...
	bool
	HttpRequest::getHeaderPara(const std::string& key, std::string& para)
	{
