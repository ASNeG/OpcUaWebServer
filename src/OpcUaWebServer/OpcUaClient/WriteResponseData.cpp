...
namespace OpcUaWebServer
{
	...
	WriteResponseData::WriteResponseData(void)
	: statusCode_("")
	{
	}
	...
	void
	WriteResponseData::statusCode(const std::string& statusCode)
	{
		statusCode_ = statusCode;
	}

	std::string&
	WriteResponseData::statusCode(void)
	{
		return statusCode_;
	}

	bool
	WriteResponseData::jsonEncode(boost::property_tree::ptree& pt)
	{
	...
	bool
	WriteResponseData::jsonDecode(boost::property_tree::ptree& pt)
	{
		return false;
	}
