...
namespace OpcUaWebServer
{
	...
	bool
	WebSocket::startup(Config* config, const IOThread::SPtr& ioThread, WebSocketServerIf* webSocketServerIf)
	{
		...
		webSocketServer_->addWebSocketServerIf(webSocketServerIf);
